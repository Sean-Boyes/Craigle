...
int main()
{
	...
	std::cout << "Trudging through the caliginous forest, the adventurer pushes forward. " + hero.m_Name + " the " + hero.m_Class + " is in search of mythical anceint riches said to reside in this forest. You have been hunting this treasure for a many fortnight by now, yet you feel you are near the end of their journey.\n\nThe forest is quiet and peaceful, but not in a comforting way. Every so often you swear you hear a quiet rustle nearby, yet nothing ever comes of it. Through the foliage the adventurer presses on. Suddenly, with an uncareful step you slip on a mud covered hillside! Down the hill you tumble, until with a crash everything goes black.\n\nYou awake with a hurting head and a few more bruises than before, and find yourself in the bottom of giant cavern, with seemingly no easy way back up. Upon looking up towards the top of the cavern, you see not the forest you were akin to but what seems to be a purple ceiling of magic. Whatever place you have found yourself in, it is clear you need to find yourself at the exit sooner than later...\n";
	_getch();
	bool death = false;
	bool movecheck;
	...
	do{
		...
		bool battlecheck = false;
			...
			while (counter < rooms[loadedroomid].m_RandEnc.size())
			{
				...
				if (percent < chance2 && movecheck == true)
				{
					battlecheck = true;
